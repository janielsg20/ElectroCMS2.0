...
## Por qué existe
Esta microfase existe para **Native permissions compiler** dentro de la responsabilidad de `F21`: mapear device capabilities. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Native permissions compiler** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
## Precondiciones
- Gate de entrada de `F21` satisfecho.
...
1. Capability use -> permission requirement.
2. Generate app config/permission descriptions.
3. Only include used permissions.
4. Request at point of use.
5. Denied/unavailable states.
