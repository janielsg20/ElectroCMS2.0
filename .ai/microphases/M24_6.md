...
## Por qué existe
Esta microfase existe para **Installer/security fixture** dentro de la responsabilidad de `F24`: generar LAMP. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Installer/security fixture** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Installer checks PHP/extensions/DB.
2. Runs migrations.
3. Locks/disables install afterward.
4. Injection/CSRF/upload/path tests.
5. Functional CRUD/form fixture.
