...
## Por qué existe
Esta microfase existe para **Content integrity y QA** dentro de la responsabilidad de `F08`: modelar CMS/workflow/indexes sin DDL dinámico. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Content integrity y QA** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Detecta missing field refs/relations/terms.
2. Schema change no destruye unknown field data automáticamente.
3. Ofrece diagnostics/cleanup explícito.
4. Prueba reopen/offline.
5. Prueba cientos/miles de records.
