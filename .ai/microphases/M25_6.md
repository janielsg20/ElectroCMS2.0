...
## Por qué existe
Esta microfase existe para **Activation/migration/uninstall QA** dentro de la responsabilidad de `F25`: generar WordPress. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Activation/migration/uninstall QA** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Plugin activation registers/migrates.
2. Deactivation safe.
3. Uninstall policy configurable, no surprise data deletion.
4. Theme activates independently.
5. WordPress fixture install/test.
