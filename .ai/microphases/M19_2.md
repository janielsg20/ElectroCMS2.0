...
**Fase propietaria:** F19 — React Native Renderer

## Por qué existe
Esta microfase existe para **Native core layout** dentro de la responsabilidad de `F19`: renderizar Native. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Native core layout** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Container -> View/Flexbox; Section es un Container preset con semantic/accessibility metadata.
2. ScrollContainer -> ScrollView/FlatList strategy.
3. Safe area handled by runtime wrapper/Container preset where needed.
4. Grid simple -> wrapped layout adapter.
5. Advanced Grid diagnostic.
