...
## Por qué existe
Esta microfase existe para **ExportIR builder y validation** dentro de la responsabilidad de `F22`: generar outputs Web/Local con dependencias mínimas. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **ExportIR builder y validation** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
## Precondiciones
- Gate de entrada de `F22` satisfecho.
...
2. Validate refs/schema/capabilities.
3. Build immutable ExportIR.
4. Strip workspace/editor history.
