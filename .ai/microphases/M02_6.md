...
## Por qué existe
Esta microfase existe para **Serializer y migrations de proyecto** dentro de la responsabilidad de `F02`: definir ownership/modelos portables mínimos. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Serializer y migrations de proyecto** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Implementa serialización determinista.
2. Checksum canonical snapshot.
3. MigrationRegistry para schemaVersion del proyecto.
4. Prueba una migration real v1->v2 ficticia.
5. Import inválido devuelve diagnostics sin mutar storage.
