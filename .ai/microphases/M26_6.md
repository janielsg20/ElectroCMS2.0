...
## Por qué existe
Esta microfase existe para **Future features document** dentro de la responsabilidad de `F26`: endurecer y proteger boundaries post-core. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Future features document** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Defer Yjs collaboration.
2. Defer XState statecharts.
3. Defer GraphQL-specific provider.
4. Defer advanced custom code sandbox/plugin SDK.
5. Define criteria to promote each into core later.
