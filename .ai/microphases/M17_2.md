...
## Por qué existe
Esta microfase existe para **Backend runtime preview** dentro de la responsabilidad de `F17`: previsualizar/diagnosticar runtime. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Backend runtime preview** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Renderiza AdminScreen/Backend documents con Refine runtime.
2. Backend theme real.
3. Role/permission checks.
4. DataView mobile/desktop modes.
5. No Puck selection overlays.
