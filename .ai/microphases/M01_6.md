...
3. Mantén obligatoriamente: `PROMPT_MAESTRO_ELECTROCMS_2.md`, `MASTER_SPEC.md`, `REQUIREMENTS.md`, `RULES.md`, `MEMORY.md`, `STATE.md`, `ARCHITECTURE.md`, `DATA_MODELS.md`, `EDITOR_ENGINE.md`, `WIDGET_SYSTEM.md`, `DESIGN_SYSTEM.md`, `THEME_SYSTEM.md`, `CONTENT_ENGINE.md`, `BACKEND_BUILDER.md`, exporters, `SECURITY.md`, `ACCESSIBILITY.md`, `TEST_STRATEGY.md`, `PHASES.md`, `TRACKING.md`, `DECISIONS.md`, `BLOCKERS.md`, `CHANGELOG.md` y `HANDOFF.md`.
