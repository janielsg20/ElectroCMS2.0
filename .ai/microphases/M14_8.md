...
## Por qué existe
Esta microfase existe para **Forms E2E** dentro de la responsabilidad de `F14`: resolver Forms con RHF/Zod/ActionGraph. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Forms E2E** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Build form visually.
2. Invalid submission.
3. Create record.
4. Conditional/multi-step.
5. Upload media ref.
