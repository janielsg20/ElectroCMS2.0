...
## Por qué existe
Esta microfase existe para **Theme/template import/export** dentro de la responsabilidad de `F07`: gestionar diseño/templates/reutilización. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Theme/template import/export** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Package manifest/version/dependencies.
2. Selective import.
3. Conflict resolution.
4. No overwrite silencioso.
5. Round-trip deterministic.
