...
## Por qué existe
Esta microfase existe para **Native Listing/Filter/Form** dentro de la responsabilidad de `F19`: renderizar Native. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Native Listing/Filter/Form** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Listing -> FlatList.
2. Filter aliases render native controls.
3. FormField maps to TextInput/Picker/switch/etc.
4. RHF stays form engine.
5. Pagination/load-more mobile appropriate.
