...
## Por qué existe
Esta microfase existe para **Static exporter** dentro de la responsabilidad de `F22`: generar outputs Web/Local con dependencias mínimas. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
