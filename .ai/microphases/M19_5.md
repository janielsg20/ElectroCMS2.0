...
## Por qué existe
Esta microfase existe para **Native admin components** dentro de la responsabilidad de `F19`: renderizar Native. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
