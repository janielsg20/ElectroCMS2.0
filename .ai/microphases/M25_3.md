...
## Por qué existe
Esta microfase existe para **CPT/Taxonomy/Fields mapping** dentro de la responsabilidad de `F25`: generar WordPress. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **CPT/Taxonomy/Fields mapping** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Content Types -> CPT.
2. Taxonomies -> WP taxonomy.
3. Fields -> meta or custom tables when justified.
4. Relations -> custom relation table/meta strategy.
5. Stable keys/migrations.
