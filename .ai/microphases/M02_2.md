...
## Por qué existe
Esta microfase existe para **Definir Component/Layout/Style** dentro de la responsabilidad de `F02`: definir ownership/modelos portables mínimos. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Definir Component/Layout/Style** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Define ElectroComponentDefinition como metadata portable, no React component.
2. Define ElectroLayout con modos semánticos.
3. Define ElectroStyle y responsive/platform overrides.
4. No guardes Tailwind/NativeWind strings como fuente canónica.
5. Define version/migration de ComponentDefinition.
