...
## Por qué existe
Esta microfase existe para **Construir Topbar y Settings Gear** dentro de la responsabilidad de `F03`: crear UX/AppShell coherentes y simples. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Construir Topbar y Settings Gear** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
## Ubicación visual
Topbar 52px; Settings gear debe quedar último al extremo derecho.
...
1. Left: breadcrumb/project/save.
2. Center: document/platform/breakpoint/history/zoom.
3. Right: Preview/Export/local indicator/Settings.
4. Settings gear siempre último extremo derecho.
5. Gear abre Sheet y restore focus al cerrar.
