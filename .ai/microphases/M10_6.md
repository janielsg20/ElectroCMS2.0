...
## Por qué existe
Esta microfase existe para **Media/RichText E2E** dentro de la responsabilidad de `F10`: gestionar media/richtext. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Media/RichText E2E** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Upload/reuse/dedupe.
2. Rich text edit inline and in record.
3. Save/reopen.
4. Delete referenced media flow.
5. Export fixture.
