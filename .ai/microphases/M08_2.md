...
## Por qué existe
Esta microfase existe para **Group/Repeater/Calculated/Conditional** dentro de la responsabilidad de `F08`: modelar CMS/workflow/indexes sin DDL dinámico. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
