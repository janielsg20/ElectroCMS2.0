...
## Por qué existe
Esta microfase existe para **Expo project/runtime bootstrap** dentro de la responsabilidad de `F20`: generar runtime Expo/data/router/admin. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Expo project/runtime bootstrap** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Create generated Expo project skeleton.
2. Include runtime-native packages only.
3. App bootstrap handles config/theme/errors.
4. No Studio editor dependencies.
5. README commands.
