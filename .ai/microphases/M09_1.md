...
## Por qué existe
Esta microfase existe para **ElectroBinding y Set From Data** dentro de la responsabilidad de `F09`: resolver bindings/queries/listings/facets/cache. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **ElectroBinding y Set From Data** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
## Precondiciones
- Gate de entrada de `F09` satisfecho.
...
1. Define binding sources mínimos.
2. Binding guarda source refs, no value resuelto.
3. Inspector Data abre Set From Data.
4. Filtra sources por type compatibility.
5. Missing source produce diagnostic reparable.
