...
## Por qué existe
Esta microfase existe para **Action node packs** dentro de la responsabilidad de `F13`: resolver workflows/automation/providers con Rete. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Action node packs** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Triggers OnClick/Press/Load/Change/Submit.
2. Logic Condition/Switch/Loop/Delay/Parallel/TryCatch as supported by engine semantics.
3. Data Query/Create/Update/Delete.
4. UI Navigate/Modal/Toast.
5. Auth/native nodes reference adapters/capabilities.
