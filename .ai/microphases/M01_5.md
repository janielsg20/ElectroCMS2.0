...
## Por qué existe
Esta microfase existe para **Crear CI base** dentro de la responsabilidad de `F01`: crear boundaries, tooling y CI. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Crear CI base** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Workflow en push/PR.
2. Install locked.
3. Ejecuta lint, typecheck, test y build.
4. Cachea dependencias de forma segura.
5. No añadas deploy/cloud secrets en esta fase.
