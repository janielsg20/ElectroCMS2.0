...
## Por qué existe
Esta microfase existe para **Construir Project Home** dentro de la responsabilidad de `F04`: persistir incrementalmente y gestionar proyectos/revisiones. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Construir Project Home** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Toolbar Search/Status/Sort/View/New.
2. Project cards desde DB real.
3. Empty state.
4. Open proyecto carga current snapshot.
5. Archive/Trash states se almacenan en projects.
