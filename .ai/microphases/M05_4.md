...
## Por qué existe
Esta microfase existe para **Sincronizar Puck actions con ElectroDocument** dentro de la responsabilidad de `F05`: integrar Puck sin duplicar su editor. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Sincronizar Puck actions con ElectroDocument** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Usa onAction/appState/prevAppState.
2. Después de una acción estable, transforma a ElectroDocument.
3. Debounce autosave por F04.
4. No necesitas MapOperations->universal CommandBus.
5. Prueba reorder/edit/duplicate/delete.
