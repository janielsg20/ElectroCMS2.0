...
## Por qué existe
Esta microfase existe para **Debug Console** dentro de la responsabilidad de `F17`: previsualizar/diagnosticar runtime. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Debug Console** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Tabs Data/State/Queries/Actions/Permissions/Diagnostics.
2. Resizable panel.
3. Redact sensitive values.
4. Only Studio/debug build.
5. Links back to source config.
