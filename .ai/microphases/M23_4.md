...
## Por qué existe
Esta microfase existe para **Signing diagnostics** dentro de la responsabilidad de `F23`: generar Android/iOS/Capacitor. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
1. Separate source-ready/build-ready/store-ready.
2. Check missing keystore/team/profile refs.
3. Never print secrets.
4. Actionable list.
5. Does not block source if signing missing.
