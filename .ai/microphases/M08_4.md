...
## Por qué existe
Esta microfase existe para **Relaciones 1:1, 1:N, N:N** dentro de la responsabilidad de `F08`: modelar CMS/workflow/indexes sin DDL dinámico. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Relaciones 1:1, 1:N, N:N** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. ElectroRelation metadata define source/target/cardinality/delete behavior.
2. Todas persisten como relation_edges.
3. Cardinality se valida en application layer.
4. Record editor ofrece selectors adecuados.
5. No cambia schema físico por cardinalidad.
