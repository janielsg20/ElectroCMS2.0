...
**Fase propietaria:** F23 — Android/iOS Export y Capacitor Fallback

## Por qué existe
Esta microfase existe para **Expo export profile** dentro de la responsabilidad de `F23`: generar Android/iOS/Capacitor. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Expo export profile** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
## Precondiciones
- Gate de entrada de `F23` satisfecho.
...
1. App name/version/package ID/bundle ID/scheme/icons/splash.
2. Permission summary from analyzer.
3. Validate identifier formats.
4. Signing refs separate from project.
5. Profile reusable.
