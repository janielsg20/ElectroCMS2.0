...
## Por qué existe
Esta microfase existe para **Theme/template QA** dentro de la responsabilidad de `F07`: gestionar diseño/templates/reutilización. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Theme/template QA** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Header/footer conditions.
2. Single current-record binding context.
3. Archive listing placeholder integration.
4. Global instances update.
5. Import conflicts.
