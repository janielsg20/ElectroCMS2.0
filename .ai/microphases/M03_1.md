...
## Por qué existe
Esta microfase existe para **Integrar shadcn/Radix y tokens Electro** dentro de la responsabilidad de `F03`: crear UX/AppShell coherentes y simples. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Integrar shadcn/Radix y tokens Electro** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Instala/integra primitives necesarios como source code.
2. Define tokens semánticos de Studio.
3. Aplica light/dark/system.
4. No construyas Button/Select/Dialog desde cero si el primitive ya existe.
5. Documenta customizaciones Electro.
