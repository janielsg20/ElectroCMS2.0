...
## Por qué existe
Esta microfase existe para **Conflict resolver y selective install** dentro de la responsabilidad de `F16`: instalar Project Kits/Blueprints sin engines nuevos. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Conflict resolver y selective install** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Detecta IDs/slugs/component/template collisions.
2. Opciones rename/skip/replace solo cuando sean seguras.
3. Permite instalar design/schema/content por partes donde tenga sentido.
4. Demo data toggle.
5. No overwrite silencioso.
