...
## Por qué existe
Esta microfase existe para **Advanced canvas guides/snapping** dentro de la responsabilidad de `F06`: añadir capacidades avanzadas/responsive sobre Puck. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Advanced canvas guides/snapping** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Rulers opcionales.
2. Guides editor-only.
3. Snapping priority guides/sibling/parent/grid.
4. Transient drag feedback; persist only final position.
5. Settings > Editor controla snapping.
