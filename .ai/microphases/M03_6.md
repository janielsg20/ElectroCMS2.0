...
## Por qué existe
Esta microfase existe para **Adaptar laptop/tablet/mobile** dentro de la responsabilidad de `F03`: crear UX/AppShell coherentes y simples. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Adaptar laptop/tablet/mobile** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Laptop: sidebar colapsable y un panel overlay si canvas se estrecha.
2. Tablet: rail + sheets.
3. Mobile: topbar compacta + bottom nav Components/Pages/Canvas/Properties/More.
4. Properties es bottom sheet; Outline full-height sheet.
5. No desaparece ninguna función primaria.
