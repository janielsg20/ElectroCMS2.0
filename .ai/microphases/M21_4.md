...
## Por qué existe
Esta microfase existe para **Notifications, Haptics y Share** dentro de la responsabilidad de `F21`: mapear device capabilities. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Notifications, Haptics y Share** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
2. Haptics semantic types.
3. Share canonical payload.
4. Action output IDs/results.
5. Web fallback/diagnostic.
