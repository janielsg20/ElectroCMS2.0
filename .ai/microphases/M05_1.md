...
## Por qué existe
Esta microfase existe para **Crear PuckAdapter y component mapping** dentro de la responsabilidad de `F05`: integrar Puck sin duplicar su editor. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Crear PuckAdapter y component mapping** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
## Precondiciones
- Gate de entrada de `F05` satisfecho.
...
1. Encapsula imports Puck en editor-puck.
2. Mapea Electro core components a Puck config.
3. Mapea ElectroDocument <-> Puck data.
4. Preserva IDs/slots.
5. Unknown component produce diagnostic visible.
