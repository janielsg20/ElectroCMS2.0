...
## Por qué existe
Esta microfase existe para **Large project/performance regression** dentro de la responsabilidad de `F27`: demostrar equivalencia/cobertura/release. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Large project/performance regression** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
3. Many media assets.
4. Long workflow.
5. Measure thresholds and fix regressions.
