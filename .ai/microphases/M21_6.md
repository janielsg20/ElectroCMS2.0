...
**Fase propietaria:** F21 — Native Device Capabilities

## Por qué existe
Esta microfase existe para **Native preview/device workflow** dentro de la responsabilidad de `F21`: mapear device capabilities. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Native preview/device workflow** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. React Native Web is approximate preview label.
2. Real device/simulator workflow uses generated Expo source.
3. Capture runtime diagnostics.
4. No claim of native parity from Web preview alone.
5. Test one app using permissions.
