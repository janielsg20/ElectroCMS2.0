...
## Por qué existe
Esta microfase existe para **iOS exporter y build** dentro de la responsabilidad de `F23`: generar Android/iOS/Capacitor. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
1. Generate Expo/iOS source/Xcode project.
2. Info permission descriptions.
3. Detect macOS/Xcode.
4. IPA only with signing.
5. Source export remains valid without signing.
