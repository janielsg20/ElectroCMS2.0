...
## Por qué existe
Esta microfase existe para **ElectroLayout/Style inspector** dentro de la responsabilidad de `F06`: añadir capacidades avanzadas/responsive sobre Puck. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **ElectroLayout/Style inspector** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
## Precondiciones
- Gate de entrada de `F06` satisfecho.
...
1. Layout/Style tabs editan canonical ElectroLayout/ElectroStyle.
2. Usa primitives Electro.
3. Container presets Row/Column/Grid/Wrap alteran layout.mode, no component type.
4. Responsive wrappers se añaden en M06.2.
5. No expongas raw CSS como default.
