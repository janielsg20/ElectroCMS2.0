...
## Por qué existe
Esta microfase existe para **Blueprint group: Servicios y gestión** dentro de la responsabilidad de `F16`: instalar Project Kits/Blueprints sin engines nuevos. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Blueprint group: Servicios y gestión** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Implementa Booking, CRM, Clinic, Helpdesk y Tattoo Studio.
2. Calendar/Kanban/admin views solo donde aporten.
3. Forms/actions actualizan records reales.
4. Notifications optional via action provider.
5. No business logic hardcoded fuera del blueprint.
