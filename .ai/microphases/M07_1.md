...
**Fase propietaria:** F07 — Themes, Templates, Blocks y Global Components

## Por qué existe
Esta microfase existe para **Project Design Tokens y themes** dentro de la responsabilidad de `F07`: gestionar diseño/templates/reutilización. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Project Design Tokens y themes** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.

## Engine owner
`Puck docs + Electro Theme/Template`
...
## Ubicación visual
Crear > Plantillas/Componentes o Apariencia > Themes/Design System.


## Precondiciones
- Gate de entrada de `F07` satisfecho.
...
1. Frontend/backend themes separados.
2. Theme = tokens + variants + metadata.
3. Studio theme no cambia.
4. Presets iniciales High Density/Minimal Clean/Bento/Dark.
5. Prueba switch sin content mutation.
