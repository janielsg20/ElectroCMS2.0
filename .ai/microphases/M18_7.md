...
## Por qué existe
Esta microfase existe para **Capability regression fixtures** dentro de la responsabilidad de `F18`: analizar compatibilidad multi-target. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Capability regression fixtures** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. All-supported fixture.
2. Adaptation fixture.
3. Fallback fixture.
4. Blocked fixture.
5. Assert codes/severity per target.
