...
## Por qué existe
Esta microfase existe para **Deployment Provider boundary** dentro de la responsabilidad de `F26`: endurecer y proteger boundaries post-core. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Deployment Provider boundary** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Deploy remains optional.
2. Define DeploymentProviderPort.
3. Provider adapters external to core.
4. Export works without Deploy.
5. UI meaningful empty state.
