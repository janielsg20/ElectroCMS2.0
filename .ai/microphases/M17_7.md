...
## Por qué existe
Esta microfase existe para **Preview E2E** dentro de la responsabilidad de `F17`: previsualizar/diagnosticar runtime. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Preview E2E** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Route navigation.
2. Content listing/filter.
3. Form submit.
4. Action workflow.
5. Role simulation.
6. Verify no editor-data mutation from rendering.
