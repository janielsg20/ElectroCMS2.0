...
## Por qué existe
Esta microfase existe para **Blueprint group: Education/community** dentro de la responsabilidad de `F16`: instalar Project Kits/Blueprints sin engines nuevos. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Blueprint group: Education/community** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Implementa LMS, Events, Membership, NGO y Blank starter.
2. Roles/content/pages/forms específicos.
3. Blank no añade demo content.
4. Todos editables después de instalar.
5. Compatibility metadata por target.
