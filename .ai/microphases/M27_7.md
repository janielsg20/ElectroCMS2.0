...
## Por qué existe
Esta microfase existe para **Security/accessibility final audit** dentro de la responsabilidad de `F27`: demostrar equivalencia/cobertura/release. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Security/accessibility final audit** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
3. Screen reader/keyboard.
4. Server generated security.
