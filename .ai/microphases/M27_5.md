...
## Por qué existe
Esta microfase existe para **LAMP/WordPress equivalence** dentro de la responsabilidad de `F27`: demostrar equivalencia/cobertura/release. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **LAMP/WordPress equivalence** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Install generated outputs.
2. CRUD/forms/query/permissions.
3. Theme/template parity.
4. Action semantics.
