...
## Por qué existe
Esta microfase existe para **Display Conditions** dentro de la responsabilidad de `F07`: gestionar diseño/templates/reutilización. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Display Conditions** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Include/exclude AST por route/content/taxonomy/role/target.
2. Resolver determinista.
3. Detecta conflicts.
4. UI rule builder compacta.
5. Exporters consumen same semantics.
