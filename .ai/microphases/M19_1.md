...
## Por qué existe
Esta microfase existe para **NativeRenderer adapter y tokens** dentro de la responsabilidad de `F19`: renderizar Native. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **NativeRenderer adapter y tokens** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
## Precondiciones
- Gate de entrada de `F19` satisfecho.
...
1. Define NativeRenderer using canonical ElectroDocument.
2. Map Project theme/tokens.
3. No React DOM imports.
4. Native errors/unknown component diagnostics.
5. Test minimal document.
