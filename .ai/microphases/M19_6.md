...
## Por qué existe
Esta microfase existe para **Native accessibility/style QA** dentro de la responsabilidad de `F19`: renderizar Native. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Native accessibility/style QA** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Accessibility roles/labels/hints.
2. Font scaling.
3. Touch targets.
4. Reduced motion.
5. NativeStyle adapter uses NativeWind/StyleSheet output, never canonical classes.
