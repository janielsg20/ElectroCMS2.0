...
## Por qué existe
Esta microfase existe para **Definir Action/State/Permission contracts** dentro de la responsabilidad de `F02`: definir ownership/modelos portables mínimos. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Definir Action/State/Permission contracts** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Define ElectroActionGraph con descriptors portables.
2. Define ElectroStateDefinition con scope/type/default/persist.
3. Define ElectroPermission/Role rules portable.
4. No modeles internals de Rete/Zustand/Refine.
5. Prueba serialización.
