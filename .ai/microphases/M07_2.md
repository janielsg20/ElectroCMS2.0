...
## Por qué existe
Esta microfase existe para **Template Manager** dentro de la responsabilidad de `F07`: gestionar diseño/templates/reutilización. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Template Manager** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Kinds Page/Header/Footer/Single/Archive/404/Section/Modal/Backend.
2. List/filter/search/cards.
3. Templates usan ElectroDocument.
4. Usage count y dependencies.
5. No component class extra por template.
