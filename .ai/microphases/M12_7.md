...
## Por qué existe
Esta microfase existe para **Permission Simulator y tests** dentro de la responsabilidad de `F12`: resolver auth/permissions/audit. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Permission Simulator y tests** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Debug select role.
2. Preview under simulated context.
3. Persistent simulation banner.
4. Test resource/field/route/action deny.
5. Test UI + service enforcement.
