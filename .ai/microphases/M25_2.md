...
## Por qué existe
Esta microfase existe para **Theme templates/rendering** dentro de la responsabilidad de `F25`: generar WordPress. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Theme templates/rendering** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Generate style.css/functions/header/footer/page/single/archive/404 and custom templates.
2. Enqueue assets.
3. Render theme tokens/styles.
4. Map Header/Footer/Single/Archive conditions.
5. Escape output.
