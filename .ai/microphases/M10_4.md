...
## Por qué existe
Esta microfase existe para **Tiptap adapter** dentro de la responsabilidad de `F10`: gestionar media/richtext. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Tiptap adapter** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Use Puck richtext for visual components.
2. Use direct Tiptap adapter for record RichText field.
3. Same allowed extension profile.
4. Electro design-system toolbar.
5. Do not install Lexical.
