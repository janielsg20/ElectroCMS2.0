...
4. Antes de aceptar datos rehidratados, valida/deserializa con Zod/schema generated from ElectroStateDefinition; el helper JSON default de Zustand no es suficiente para datos corruptos/tampered.
