...
## Por qué existe
Esta microfase existe para **Configurar TypeScript y boundaries** dentro de la responsabilidad de `F01`: crear boundaries, tooling y CI. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Configurar TypeScript y boundaries** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Activa strict TypeScript.
2. Domain no puede importar React, Puck, Drizzle, Expo, DOM o filesystem.
3. Application depende de domain/ports.
4. Adapters dependen de ports/engines.
5. Configura aliases y architecture tests que fallen ante import prohibido.
