...
## Por qué existe
Esta microfase existe para **Mobile export fixtures** dentro de la responsabilidad de `F23`: generar Android/iOS/Capacitor. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
1. Native-compatible fixture.
2. Web-only fallback fixture.
3. Generate source for Android/iOS/Capacitor.
4. Build where runners available.
5. Verify dependencies/artifacts.
