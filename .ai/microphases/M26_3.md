...
## Por qué existe
Esta microfase existe para **Performance hardening** dentro de la responsabilidad de `F26`: endurecer y proteger boundaries post-core. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Performance hardening** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Profile Puck medium/large docs.
2. PGlite records/query.
3. TanStack virtualization as needed.
4. Media thumbnails/lazy load.
5. Export duration/memory.
