...
## Por qué existe
Esta microfase existe para **Saved blocks y global components** dentro de la responsabilidad de `F07`: gestionar diseño/templates/reutilización. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Saved blocks y global components** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Saved block = composite ElectroDocument subtree package.
2. Global component = reusable definition + instances/overrides.
3. No convertir cada block en hardcoded runtime class.
4. Edit global muestra affected instances.
5. Detach supported.
