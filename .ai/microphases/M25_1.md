...
## Por qué existe
Esta microfase existe para **WordPress export structure** dentro de la responsabilidad de `F25`: generar WordPress. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **WordPress export structure** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
## Precondiciones
- Gate de entrada de `F25` satisfecho.
...
1. Separate Theme and Companion Plugin ZIPs.
2. Unique namespace/prefix.
3. Version metadata.
4. Install instructions.
5. No external builder dependency.
