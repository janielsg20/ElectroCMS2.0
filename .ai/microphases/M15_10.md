...
## Por qué existe
Esta microfase existe para **Backend E2E** dentro de la responsabilidad de `F15`: resolver Backend con Refine/TanStack. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Backend E2E** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
2. Generate admin list/create/edit/detail.
3. Sort/filter/page/select.
4. Saved view.
5. Mobile card view.
6. Save/reopen backend document.
