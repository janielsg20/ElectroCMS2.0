...
## Por qué existe
Esta microfase existe para **Construir AppShell desktop** dentro de la responsabilidad de `F03`: crear UX/AppShell coherentes y simples. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Construir AppShell desktop** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Implementa 100dvh root.
2. Reserva Sidebar 240/64, Topbar 52, workspace flexible y Statusbar 26.
3. Evita body scroll global.
4. Canvas/workspace outlet debe tener min-width seguro.
5. Prueba layout sin contenido.
