...
## Por qué existe
Esta microfase existe para **Conditional/Multi-step/Draft** dentro de la responsabilidad de `F14`: resolver Forms con RHF/Zod/ActionGraph. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Conditional/Multi-step/Draft** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Conditional usa form value rules.
2. Multi-step valida current step.
3. Draft usa form_drafts table solo si enabled.
4. RHF field arrays para repeater donde convenga.
5. No crear custom state for fields.
