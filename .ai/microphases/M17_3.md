...
## Por qué existe
Esta microfase existe para **Preview routing y 404** dentro de la responsabilidad de `F17`: previsualizar/diagnosticar runtime. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Preview routing y 404** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Map ElectroRoutes.
2. Back/forward dentro del preview.
3. Unknown route renders 404 template.
4. Deep links.
5. Preview route isolation from Studio routing.
