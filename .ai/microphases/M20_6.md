...
## Por qué existe
Esta microfase existe para **Assets and route source generation** dentro de la responsabilidad de `F20`: generar runtime Expo/data/router/admin. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Assets and route source generation** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
2. Stable generated paths.
3. Bundle app icons/splash separately.
4. Generate route files from compiler.
5. No temp URLs.
