...
## Por qué existe
Esta microfase existe para **ElectroBlueprint manifest e installer** dentro de la responsabilidad de `F16`: instalar Project Kits/Blueprints sin engines nuevos. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **ElectroBlueprint manifest e installer** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
## Precondiciones
- Gate de entrada de `F16` satisfecho.
...
1. Blueprint package incluye schema, documents, templates, backend, roles, queries, forms, actions, themes, assets refs y optional demo data.
2. Installer valida todo antes de aplicar.
3. Apply transaccional sobre Project/Content services.
4. Rollback completo ante fallo.
5. No usar APIs privadas del Studio.
