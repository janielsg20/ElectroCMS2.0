...
## Por qué existe
Esta microfase existe para **PWA exporter** dentro de la responsabilidad de `F22`: generar outputs Web/Local con dependencias mínimas. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **PWA exporter** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. React/Web base.
2. Manifest/icons/service worker.
3. Offline shell and chosen data cache.
4. Installability.
5. No cloud requirement.
