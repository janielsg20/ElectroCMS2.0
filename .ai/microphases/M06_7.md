...
## Por qué existe
Esta microfase existe para **Mobile/tablet editor tools** dentro de la responsabilidad de `F06`: añadir capacidades avanzadas/responsive sobre Puck. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Mobile/tablet editor tools** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Puck Preview sigue canvas.
2. Components/Outline/Properties se montan en sheets según AppShell.
3. Drag tiene alternativa click-to-insert y keyboard.
4. No duplicar editor mobile separado.
5. Prueba 360/430/768.
