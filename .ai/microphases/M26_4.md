...
## Por qué existe
Esta microfase existe para **Offline/recovery hardening** dentro de la responsabilidad de `F26`: endurecer y proteger boundaries post-core. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
