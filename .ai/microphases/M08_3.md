...
## Por qué existe
Esta microfase existe para **Taxonomías** dentro de la responsabilidad de `F08`: modelar CMS/workflow/indexes sin DDL dinámico. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Taxonomías** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Crea ElectroTaxonomy metadata.
2. Terms persisten en taxonomy_terms.
3. Hierarchical usa parentId.
4. Attached Content Types son refs.
5. UI separa definición de taxonomy y administración de terms.
