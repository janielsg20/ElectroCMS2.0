...
## Por qué existe
Esta microfase existe para **Compatibility Screen** dentro de la responsabilidad de `F18`: analizar compatibilidad multi-target. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Compatibility Screen** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
2. Target selector.
3. Ready/Adaptations/Warnings/Blockers sections.
4. Click diagnostic navigates to source.
5. Export button disabled on blocker.
