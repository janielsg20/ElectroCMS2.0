...
## Por qué existe
Esta microfase existe para **Text/RichText inline editing** dentro de la responsabilidad de `F05`: integrar Puck sin duplicar su editor. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Text/RichText inline editing** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Usa Puck text contentEditable para Text/Heading donde aplique.
2. Usa Puck richtext/Tiptap para RichText.
3. No crea direct-edit engine propio.
4. Shortcuts globales no interfieren con contentEditable.
5. Prueba commit/cancel/history.
