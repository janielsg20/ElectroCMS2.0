...
## Por qué existe
Esta microfase existe para **AdminScreen/Route definitions** dentro de la responsabilidad de `F15`: resolver Backend con Refine/TanStack. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
