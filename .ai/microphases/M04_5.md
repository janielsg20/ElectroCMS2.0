...
## Por qué existe
Esta microfase existe para **New Project Wizard y project actions** dentro de la responsabilidad de `F04`: persistir incrementalmente y gestionar proyectos/revisiones. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **New Project Wizard y project actions** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Wizard Basic/Blueprint/Design/Demo/Review.
2. Create transaccional.
3. Rename solo display name.
4. Duplicate genera IDs nuevos y no copia history transient.
5. Archive/Trash/Restore/Permanent delete con reglas.
