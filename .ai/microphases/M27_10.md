...
1. Update README/architecture/engine matrix.
2. Document supported targets and known adaptations.
3. Pin tested dependency versions.
4. Release checklist.
5. Only release with zero critical blockers.
