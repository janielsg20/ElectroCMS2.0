...
## Por qué existe
Esta microfase existe para **Files y Secure Storage** dentro de la responsabilidad de `F21`: mapear device capabilities. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
