...
## Por qué existe
Esta microfase existe para **Construir Context/Canvas/Inspector/Status** dentro de la responsabilidad de `F03`: crear UX/AppShell coherentes y simples. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Construir Context/Canvas/Inspector/Status** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.

## Engine owner
`shadcn/Radix + AppShell`
...
## Ubicación visual
Workspace central; Context 288px, Canvas flex dominante, Inspector 320px, Statusbar 26px.
...
1. Context 288px resizable 240–380.
2. Canvas flex:1.
3. Inspector 320px resizable 280–440.
4. Status 26px info-only.
5. En esta fase usa placeholders estructurales explícitos, no funciones simuladas.
