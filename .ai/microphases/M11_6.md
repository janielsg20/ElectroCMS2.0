...
## Por qué existe
Esta microfase existe para **State E2E** dentro de la responsabilidad de `F11`: resolver runtime state con Zustand. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **State E2E** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Component/page/app scopes.
2. Persistent reopen.
3. Binding update.
4. Action update.
5. Web/native compatibility.
