...
## Por qué existe
Esta microfase existe para **Canonical E2E project** dentro de la responsabilidad de `F27`: demostrar equivalencia/cobertura/release. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Canonical E2E project** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
## Precondiciones
- Gate de entrada de `F27` satisfecho.
...
1. Build project using pages/templates/content/relations/query/filter/form/backend/roles/state/actions/media.
2. Use only public Electro APIs.
3. Version fixture.
4. Include at least one Native capability.
5. Include no target-only hack.
