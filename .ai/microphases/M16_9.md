...
## Por qué existe
Esta microfase existe para **Blueprint QA** dentro de la responsabilidad de `F16`: instalar Project Kits/Blueprints sin engines nuevos. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Blueprint QA** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Instala cada blueprint en project limpio.
2. Valida no conflicts.
3. Abre frontend/backend.
4. Ejecuta al menos un workflow principal por grupo.
5. Export compatibility smoke por destino principal.
