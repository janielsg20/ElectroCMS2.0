...
## Por qué existe
Esta microfase existe para **Create/Edit/Detail with Refine RHF** dentro de la responsabilidad de `F15`: resolver Backend con Refine/TanStack. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Create/Edit/Detail with Refine RHF** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Use @refinedev/react-hook-form integration.
2. Render Electro Form controls/schema.
3. Create/edit/clone orchestration delegated to Refine.
4. Dirty/autosave if enabled uses Refine/RHF capabilities.
