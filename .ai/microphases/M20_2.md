...
## Por qué existe
Esta microfase existe para **Expo Router stable Stack/JS Tabs compiler** dentro de la responsabilidad de `F20`: generar runtime Expo/data/router/admin. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.
...
9. Permission guard wraps route using ElectroPermission/Auth context.
