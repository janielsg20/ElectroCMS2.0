...
## Por qué existe
Esta microfase existe para **Component/style capabilities** dentro de la responsabilidad de `F18`: analizar compatibilidad multi-target. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Component/style capabilities** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Core ComponentDefinition declares targets.
2. Layout/style properties declare target support.
3. Container Grid advanced -> Native adapted/diagnostic.
4. Embed/Iframe -> Web/Capacitor primarily.
5. Inspector can show capability badges.
