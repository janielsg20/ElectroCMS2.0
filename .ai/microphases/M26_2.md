...
## Por qué existe
Esta microfase existe para **Accessibility hardening** dentro de la responsabilidad de `F26`: endurecer y proteger boundaries post-core. Debe cerrar una capacidad concreta y no abrir un subsystem paralelo.

## Resultado exacto
Al cerrar esta microfase, **Accessibility hardening** debe existir como capacidad real, integrada y verificable. No se acepta placeholder ni una implementación paralela al engine.
...
1. Keyboard full Studio flow.
2. Focus/overlays.
3. Contrast/text scale/reduced motion.
4. Drag alternatives.
5. Representative generated Web/Native a11y.
